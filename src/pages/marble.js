...
import { miradorDownloadPlugin, MiradorDownloadDialogPlugin } from '../components/miradordlplugin'
  ...
  return (
    <Layout location={location}>
      <Seo
        ...
        noIndex
      />
      <MiradorRenderer  id="marble-viewer" location={location} plugins={[...miradorImageToolsPlugin, miradorDownloadPlugin, MiradorDownloadDialogPlugin]} themeColor="#blue" />
    </Layout>
  )
}
